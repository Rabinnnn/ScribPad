...
public class Treatment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        mClearButton = view.findViewById(R.id.clear_pad);
        mSaveButton = view.findViewById(R.id.save_new_file);
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    ...
                    Intent i = new Intent(getActivity(), UploadTreatment.class);
                    startActivity(i);
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            File photo = new File(getAlbumStorageDir("SignaturePad"), String.format("Treatment_%d.jpg", System.currentTimeMillis()));
    ...
    public boolean addSvgSignatureToGallery(String signatureSvg) {
        ...
        try {
            File svgFile = new File(getAlbumStorageDir("SignaturePad"), String.format("Treatment_%d.svg", System.currentTimeMillis()));
