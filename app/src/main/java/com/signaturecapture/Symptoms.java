...
public class Symptoms extends Fragment {
   // private ActivityCreateNewRecord2Binding binding;
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            File photo = new File(getAlbumStorageDir("SignaturePad"), String.format("Symptoms_%d.jpg", System.currentTimeMillis()));
    ...
    public boolean addSvgSignatureToGallery(String signatureSvg) {
        ...
        try {
            File svgFile = new File(getAlbumStorageDir("SignaturePad"), String.format("Symptoms_%d.svg", System.currentTimeMillis()));
