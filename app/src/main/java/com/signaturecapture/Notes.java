...
public class Notes extends Fragment {
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            File photo = new File(getAlbumStorageDir("SignaturePad"), String.format("Notes_%d.jpg", System.currentTimeMillis()));
    ...
    public boolean addSvgSignatureToGallery(String signatureSvg) {
        ...
        try {
            File svgFile = new File(getAlbumStorageDir("SignaturePad"), String.format("Notes_%d.svg", System.currentTimeMillis()));
