...
public class ShowTreatment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference listRef = FirebaseStorage.getInstance().getReference().child("treatment/"+ Search_Existing_Records.name.getText().toString()+"/");
